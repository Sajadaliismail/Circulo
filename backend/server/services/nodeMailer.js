...
>
  ...
  <div style="position: relative; display: inline-block; margin-bottom: 30px;">
    <h1 style="font-size: 3em; letter-spacing: 4px; text-align: center; padding: 20px; background: #fff; color: #0072ff; border-radius: 10px; display: inline-block;" id="otp">${params.OTP}</h1>
  </div>
