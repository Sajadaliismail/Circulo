    ...
    return (
        <>
            <Box id="accordion-panel">
                ...
                >
                    <StyledAccordionSummary expandIcon={<ExpandLess />} aria-controls="panel1-content" id="panel1-header">
                        Chats
                        ...
                        <Box>
                            ...
                            <Box>
                                {onlinePeople.map((person) => (
                                    <Box onClick={()=>{handleConversationClick(person.converSationId)}}  key={person.id} sx={{ display: 'flex', alignItems: 'center', marginBottom: 1 }} >
