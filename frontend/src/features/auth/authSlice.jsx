...
import { sendOtp, signup, signin, verifyOtp, updatePassword, addressSetup } from './authAsyncThunks'
...
export const { setError,setEmail,setLogout,setIsSetupComplete} = authSlice.actions
